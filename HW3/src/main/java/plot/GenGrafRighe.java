...
public class GenGrafRighe extends ApplicationFrame {

    private final JFreeChart chart;

    public GenGrafRighe(final String titolo, HashMap<Long, Integer> map) {
        super(titolo);
        final DefaultCategoryDataset dataset = createDataset(map);
        chart = ChartFactory.createBarChart(titolo, "Numero di righe", "Quantità",
